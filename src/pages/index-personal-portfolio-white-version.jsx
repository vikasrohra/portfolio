...
const IndexPage = ({ data }) => {
    ...
    return (
        <Layout
            pageTitle="Home Personal Portfolio White Version"
            className="white-version personal-portfolio"
        >
            <Header
                data={{
                    ...data.header,
...
export const query = graphql`
    query PersonalPortfolioWhitePageQuery {
        site {
            ...Site
        }
        ...
        homePage(title: { eq: "personal-portfolio-home-white" }) {
            content {
                ...Content01
            }
        }
